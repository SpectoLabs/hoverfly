...
func Test_Middleware_executeMiddlewareRemotely_ReturnsErrorIfDoesntGetA200_AndSameRequestResponsePairs(t *testing.T) {
	...
	Expect(err.Error()).To(ContainSubstring(`{"response":{"status":0,"body":"Normal body","bodyFile":"","encodedBody":false},"request":{"path":"","method":"","destination":"","scheme":"","query":"","body":"","headers":null}}`))
