...
mandatory option to specify :code:`-response-body-files-allowed-origin` that lets you explicitly set the collections of
urls to allow body files to be downloaded from. For the above to work you need to run hoverfly like this:

.. code:: bash

    hoverfly -response-body-files-allowed-origin="https://raw.githubusercontent.com/"