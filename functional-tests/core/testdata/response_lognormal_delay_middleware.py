...
logging.basicConfig(filename='response_delay_middleware_request.log', level=logging.DEBUG)
...
def main():
    ...
    payload_dict['response']['logNormalDelay'] = {'min': 130, 'max': 160, 'mean': 150, 'median': 140}
