...
var _ = Describe("/api/v2/hoverfly/usage", func() {
	...
	Context("GET", func() {
		...
		It("Should get the usage counters", func() {
			...
			Expect(err).To(BeNil())
			Expect(modeJson).To(Equal([]byte(`{"usage":{"counters":{"capture":0,"modify":0,"simulate":0,"spy":0,"synthesize":0}}}`)))
		})
		...
		It("Should get the usage counters with 1 simulate request when a request has been made", func() {
			...
			modeJson, err := ioutil.ReadAll(res.Body)
			Expect(err).To(BeNil())
			Expect(modeJson).To(Equal([]byte(`{"usage":{"counters":{"capture":0,"modify":0,"simulate":1,"spy":0,"synthesize":0}}}`)))
		})
		...
		It("Should get the usage counters with 1 capture request when a request has been made", func() {
			...
			modeJson, err := ioutil.ReadAll(res.Body)
			Expect(err).To(BeNil())
			Expect(modeJson).To(Equal([]byte(`{"usage":{"counters":{"capture":1,"modify":0,"simulate":0,"spy":0,"synthesize":0}}}`)))
		})
		...
		It("Should get the usage counters with 1 modify request when a request has been made", func() {
			...
			modeJson, err := ioutil.ReadAll(res.Body)
			Expect(err).To(BeNil())
			Expect(modeJson).To(Equal([]byte(`{"usage":{"counters":{"capture":0,"modify":1,"simulate":0,"spy":0,"synthesize":0}}}`)))
		})
		...
		It("Should get the usage counters with 1 modify request when a request has been made", func() {
			...
			modeJson, err := ioutil.ReadAll(res.Body)
			Expect(err).To(BeNil())
			Expect(modeJson).To(Equal([]byte(`{"usage":{"counters":{"capture":0,"modify":0,"simulate":0,"spy":0,"synthesize":1}}}`)))
		})
		...
		It("Should get the usage counters with 1 spy request when a request has been made", func() {
			...
			modeJson, err := ioutil.ReadAll(res.Body)
			Expect(err).To(BeNil())
			Expect(modeJson).To(Equal([]byte(`{"usage":{"counters":{"capture":0,"modify":0,"simulate":0,"spy":1,"synthesize":0}}}`)))
		})
	})
})
